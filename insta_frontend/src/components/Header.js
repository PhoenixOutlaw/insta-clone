...
export const Header = () => {
  ...
  useEffect(() => {
    axios.post("/search", { username: searched }).then(async (req) => {
    ...
    <div>
      <div className="headercontainer">
        ...
        <div className="searchcontainer">
          ...
          {searchmenu && (
            <div
              onMouseLeave={() => setsearchmenu(false)}
              className="searchbox"
            >
              {searchresult !== "" ? (
                searchresult.map((usern) => (
                  <div key={usern?.profile_id}>
                    <Search username={usern?.username} />
                  </div>
                ))
              ) : (
                <h6
        ...
        <div className="headeroption">
          ...
          <div>
            ...
            />
           {popup&& <div className="popdiv" onMouseEnter={() => setpopup(false)}>
                </div>}
            {popup && (
                <div className="popup">
